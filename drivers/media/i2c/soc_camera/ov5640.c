...
{
	if (fie->pad || fie->index >= ARRAY_SIZE(ov5640_frame_rates))
		return -EINVAL;
	fie->interval.numerator = 1;
	fie->interval.denominator = ov5640_frame_rates[fie->index];
	return 0;
}
 ...
 */
static int ov5640_enum_framesize(struct v4l2_subdev *sd,
			struct v4l2_subdev_pad_config *cfg,
...
static const struct v4l2_subdev_pad_ops ov5640_pad_ops = {
	...
	.enum_frame_size	= ov5640_enum_framesize,
 };
